...
### 1.	PART I: Get all the unique Tags and attributes, and write them into a CSV:
...
### 2. PART II: Get the XML Path, check for spelling, and errors:
...
### 3. XML to CSV. Taking MODS XML files and converting them to a workbench csv:
